  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="signal-particle absolute left-[30%] top-[64%] h-2 w-2 rounded-full bg-accent shadow-[0_0_16px_4px_color-mix(in_oklab,var(--color-accent)_50%,transparent)] motion-reduce:animate-none" />
      </div>
    </div>
  );
}
